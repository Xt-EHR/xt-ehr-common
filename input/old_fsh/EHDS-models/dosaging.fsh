...
* renderedDescription 0..1 string "Textual representation of the structued content"
* text 0..1 string "Free text usage/dosage instructions when information is not structured." "Free text usage/dosage instructions when information is not structured or not structured enough to be machine-readable. This is a fallback for the structured content, e.g. 'Take 1 tablet three times a day'."
