...
* authorisingEntity[x] 0..1 EHDSPatient or EHDSHealthProfessional or EHDSRelatedPerson or EHDSOrganisation "Person or organisation that authorises the directive"
  * ^requirements = "ISO IPS"
