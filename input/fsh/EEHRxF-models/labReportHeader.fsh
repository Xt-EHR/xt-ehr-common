...
* intendedRecipient 0..* Reference(EEHRxFPatient or EEHRxFRelatedPerson or EEHRxFHealthProfessional or EEHRxFOrganization or EEHRxFHealthProfessionalRole or EEHRxFDevice) "A.1.5 - Intended recipient" """Information recipient (intended recipient or recipients of the report, additional recipients might be identified by the ordering party, e.g. GP, other specialist), if applicable"""
* author 1..* EEHRxFHealthProfessionalRole "A.1.6 - Author" """Author by whom the document was/were authored. Multiple authors could be provided."""
* attester 0..* EEHRxFHealthProfessionalRole "A.1.7 - Attester" """Attester who validated the document. Mulitple attesters could be provided."""
* legalAuthenticator 0..1 EEHRxFHealthProfessionalRole "A.1.8 - Legal authenticator" """The person taking responsibility for the medical content of the document"""
* documentMetadata 1..1 BackboneElement "A.1.9 - Document metadata" """Data relevent to document type and its content for administrative and searching purposes."""
  ...
  * reportCustodian 1..1 EEHRxFOrganization "A.1.9.9 - Report custodian" """Organisation that is in charge of maintaining the report [this element will include organisation ID, name, address etc., as other elements describing organisations]."""
...
* media[x] 0..* EEHRxFAttachment or EEHRxFMedia "A.1.11 - Media" """Media attachments."""
