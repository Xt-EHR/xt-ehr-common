...
* networkAffiliation 0..* Reference(EHNOrganisationModel) "Network affiliation" "The HP organisation is affiliated with a European network, for example an ERN."
