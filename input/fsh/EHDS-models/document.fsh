...
* header ^short = "Document header elements"
  ...
  * attestation 0..* Base "Attestation" """Document attestation details"""
    * attester[x] 1..1 EHDSHealthProfessional or EHDSDevice "Attester" """Attester who validated the document. Multiple attesters could be provided."""
  ...
  * legalAuthentication 0..1 Base "Legal authentication" """Document legal authentication"""
    * legalAuthenticator[x] 1..1 EHDSHealthProfessional or EHDSOrganisation "Legal authenticator" """The person or organization taking responsibility for the medical content of the document"""
    * datetime 1..1 dateTime "DateTime" """Date and time when the document was authorized."""
    * datetime ^comment = """Time stamp of document verification by a legal authenticator."""
