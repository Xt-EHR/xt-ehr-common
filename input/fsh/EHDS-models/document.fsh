...
* header ^short = "Document header elements"
  ...
  * attestation 0..* Base "Document attestation details"
    * attester 1..1 EHDSHealthProfessional "Attester who validated the document. Mulitple attesters could be provided."
  ...
  * legalAuthentication 0..1 Base "Document legal authentication details"
    * legalAuthenticator 1..1 EHDSHealthProfessional "The person taking responsibility for the medical content of the document"
