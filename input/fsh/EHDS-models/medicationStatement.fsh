...
* dosageInstructions 1..1 EHDSDosaging "Details of how medication is/was taken or should be taken" "Details of how medication is/was taken or should be taken. This includes the number of units per intake and frequency of intake over a specified duration of time. Example: 1 tablet every 24h, for 10 days ."
  * ^requirements = "eHN PS Guideline, ISO IPS, MyHealth@EU"
