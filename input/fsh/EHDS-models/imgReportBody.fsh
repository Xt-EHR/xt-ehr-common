...
* examinationReport 1..1 Base "B.1.5 - Examination Report" """Examination Report"""
  ...
  * conclusion 1..1 Base "B.1.5.7 - Conclusion" """Conclusions in narrative and coded form."""
    * impression 1..1 Narrative "B.1.5.7.1 - Impression" """Narrative description of the clinical conclusion (impression)."""
    * codedConclusion 0..1 Base "B.1.5.7.2 - Coded conclusion" """Condition or finding from imaging investigation."""
