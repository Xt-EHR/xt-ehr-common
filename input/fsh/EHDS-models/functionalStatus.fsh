...
* functionalStatusAssessment 0..* Base "C.25.5 - Functional status assessment" """Functional status assessment of various aspects of the functional status of the patient."""
