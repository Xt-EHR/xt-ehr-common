...
* manufacturer 0..1 string "Name of device manufacturer. If the manufacturer code is included in an identifier, anufacturer must correspond to that code."
...
* lotNumber 0..1 string "Lot number of device. May not to be populated if included in an identifier."
* serialNumber 0..1 string "Serial number assigned by the manufacturer. May not to be populated if included in an identifier."
