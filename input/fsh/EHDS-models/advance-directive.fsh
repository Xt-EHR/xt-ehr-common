...
* authorisingEntity[x] 0..1 EHDSPatient or EHDSHealthProfessional or EHDSRelatedPerson or EHDSOrganization "Person or organisation that authorizes the directive"
  * ^requirements = "ISO IPS"
