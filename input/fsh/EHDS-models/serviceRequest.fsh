...
* reason[x] 0..* CodeableConcept or EHDSObservation or EHDSCondition or EHDSProcedure or EHDSMedicationUse or string "A code, text or reference to reason why this service is being requested."
