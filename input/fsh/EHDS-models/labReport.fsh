...
//    * orderReasonText 0..* string "An explanation or justification for why this service is being requested in textual form."
    * orderReason[x] 0..* CodeableConcept or EHDSCondition or EHDSProcedure or EHDSObservation or EHDSMedication or string "An explanation or justification for why this service is being requested in coded form."
