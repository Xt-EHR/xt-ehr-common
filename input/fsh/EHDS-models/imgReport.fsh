...
* body ^short = "Imaging Report structured body"
  * orderInformation 0..* Base "Order Information (Imaging Result Report could respond to multiple orders)."
    ...
    * orderPlacer[x] 0..1 EHDSHealthProfessional or EHDSOrganization or EHDSPatient "The person/organization \"authorised\" to place the order. Order placer could be either a health professional, health professional organization or the patient himself."
  ...
  * exposureInformation 0..1 Base "Information on total exposure to ionising radiation."
