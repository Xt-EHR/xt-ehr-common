...
* receiver 0..1 Reference(EHDSPatient or EHDSHealthProfessionalRole) "Identification of the person who received the dispensed medication, especially when it was not the patient"
  * ^comment = "Added"
* dispenser 1..1 Reference(EHDSHealthProfessionalRole or EHDSOrganization or EHDSDevice) "The person who dispensed the product, and takes the responsibility of the dispensation"
...
Logical: EHDSMedicationPrescriptionGroup
Title: "Prescription Experimental (model)"
Description: "Logical model for medication prescription that may contain multiple medications"
Characteristics: #can-be-target
...
* statusReasonText 0..1 string "Textual reason for the current status of prescription"
  * ^comment = "Added."
* comment 0..* string "Additional information or comments"
* medicationRequest 1..* BackboneElement "Presription line for one medication. In many countries, only one line is allowed. In case multiple medications are allowed, all lines need to be authored together."
