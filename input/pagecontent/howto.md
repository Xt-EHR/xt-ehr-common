...
The models use a subset of FHIR data types, but do not imply all the extensions or constraints that the FHIR format defines. Please see [Data types and references page](datatypes.html) for additional information about data types in the logical models.
