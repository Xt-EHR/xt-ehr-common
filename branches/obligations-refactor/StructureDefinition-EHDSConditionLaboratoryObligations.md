# Condition laboratory specific obligations - EHDS Logical Information Models v0.4.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Condition laboratory specific obligations**

## Logical Model: Condition laboratory specific obligations 

| | |
| :--- | :--- |
| *Official URL*:http://www.xt-ehr.eu/fhir/models/StructureDefinition/EHDSConditionLaboratoryObligations | *Version*:0.4.0 |
| Draft as of 2026-03-10 | *Computable Name*:EHDSConditionLaboratoryObligations |
...
```json
{
  ...
  "baseDefinition" : "http://www.xt-ehr.eu/fhir/models/StructureDefinition/EHDSConditionObligations",
