...
| Draft as of 2026-03-10 | *Computable Name*:EHDSImmunisationLaboratoryObligations |
...
```json
{
  ...
  "baseDefinition" : "http://www.xt-ehr.eu/fhir/models/StructureDefinition/EHDSImmunisationObligations",
