...
| Draft as of 2026-03-10 | *Computable Name*:EHDSPatientLaboratoryObligations |
...
```json
{
  ...
  "baseDefinition" : "http://www.xt-ehr.eu/fhir/models/StructureDefinition/EHDSPatientObligations",
