...
| Draft as of 2026-02-21 | *Computable Name*:EHDSMedicationPrescriptionObligations |
...
```json
{
  ...
  "status" : "draft",
  "date" : "2026-02-21T23:22:13+00:00",
  "publisher" : "Xt-EHR",
  "contact" : [{
    "name" : "Xt-EHR",
    "telecom" : [{
  ...
  "differential" : {
    "element" : [{
      ...
      "definition" : "Obligations for the logical model for medication prescription body for prescribing systems."
    },
    {
    ...
    },
    {
      ...
      "extension" : [{
        ...
        {
          "url" : "documentation",
          "valueMarkdown" : "A system making prescriptions available shall provide a rendered, human-readable version of the prescription,"
        }],
        "url" : "http://hl7.org/fhir/StructureDefinition/obligation"
      }],
    ...
    {
      "id" : "EHDSMedicationPrescriptionObligations.prescriptionItem.substitution.allowed[x]",
      "path" : "EHDSMedicationPrescriptionObligations.prescriptionItem.substitution.allowed[x]",
      "slicing" : {
        "discriminator" : [{
          "type" : "type",
          "path" : "$this"
    ...
    {
      "id" : "EHDSMedicationPrescriptionObligations.prescriptionItem.substitution.allowed[x]:allowedBoolean",
      "extension" : [{
        "extension" : [{
          "url" : "code",
          "valueCode" : "SHOULD:able-to-populate"
