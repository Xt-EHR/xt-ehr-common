# Dosage obligations - EHDS Logical Information Models v0.4.0
...
| Draft as of 2026-02-21 | *Computable Name*:EHDSDosageObligations |
...
```json
{
  ...
  "differential" : {
    ...
    {
      "id" : "EHDSDosage.dosageDetails.doseAndRate.dose[x]:doseQuantity",
      "path" : "EHDSDosage.dosageDetails.doseAndRate.dose[x]",
    ...
    {
      "id" : "EHDSDosage.dosageDetails.doseAndRate.dose[x]:doseRange",
      "extension" : [{
        "extension" : [{
          "url" : "code",
          "valueCode" : "SHOULD:able-to-populate"
    ...
    {
      "id" : "EHDSDosage.dosageDetails.repeat.bounds[x]:boundsQuantity",
      "path" : "EHDSDosage.dosageDetails.repeat.bounds[x]",
      "sliceName" : "boundsQuantity",
      "min" : 0,
      "max" : "1",
      "type" : [{
        "code" : "Quantity"
