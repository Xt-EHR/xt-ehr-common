...
| Draft as of 2026-01-30 | *Computable Name*:EHDSMedicationPrescription |
  ...
  "differential" : {
    "element" : [
      ...
      },
      {
        ...
        "short" : "The period over which the prescription is considered valid and dispenseable. validityPeriod.start is, if missing, is assumed to be the date of issuing the prescription.",
        "definition" : "The period over which the prescription is considered valid and dispenseable. validityPeriod.start is, if missing, is assumed to be the date of issuing the prescription.",
        "min" : 0,
        "max" : "1",
        "type" : [
          {
