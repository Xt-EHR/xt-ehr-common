...
| Draft as of 2026-02-02 | *Computable Name*:EHDSSpecimen |
...
* Use this Logical Model: [Imaging report model](StructureDefinition-EHDSImagingReport.md), [Imaging study model](StructureDefinition-EHDSImagingStudy.md), [Laboratory report model](StructureDefinition-EHDSLaboratoryReport.md), [Media model](StructureDefinition-EHDSMedia.md)... Show 2 more, [Observation model](StructureDefinition-EHDSObservation.md) and [Service request model](StructureDefinition-EHDSServiceRequest.md)
