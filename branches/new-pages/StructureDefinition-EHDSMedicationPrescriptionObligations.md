...
| Draft as of 2026-02-26 | *Computable Name*:EHDSMedicationPrescriptionObligations |
...
```json
{
  ...
  "status" : "draft",
  "date" : "2026-02-26T16:17:52+00:00",
  "publisher" : "Xt-EHR",
  "contact" : [{
    "name" : "Xt-EHR",
    "telecom" : [{
  ...
  "differential" : {
    ...
    },
    {
      ...
      "extension" : [{
        ...
        {
          "url" : "documentation",
          "valueMarkdown" : "System SHALL support at least boolean data type for the element."
        }],
        "url" : "http://hl7.org/fhir/StructureDefinition/obligation"
      }],
