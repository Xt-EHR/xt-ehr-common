...
| Draft as of 2026-02-05 | *Computable Name*:EHDSMedia |
...
* Use this Logical Model: [Discharge Report model](StructureDefinition-EHDSDischargeReport.md) and [Laboratory report model](StructureDefinition-EHDSLaboratoryReport.md)
...
```json
{
  ...
  "title" : "Media model",
  "status" : "draft",
  "date" : "2026-02-05T14:37:54+00:00",
  "publisher" : "Xt-EHR",
  "contact" : [
    {
      "name" : "Xt-EHR",
