...
Information models derived from EHDS information models including obligations for data elements.
...
| [Observation obligations](StructureDefinition-EHDSObservationObligations.md) | Obligations for the logical model for observation. |
