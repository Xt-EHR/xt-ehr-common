...
EHDS refined base model for communication contact information structure 
    ...
    "element" : [
      {
        ...
        "path" : "EHDSTelecom",
        "short" : "Telecom model",
        "definition" : "EHDS refined base model for communication contact information structure"
      },
      {
        "id" : "EHDSTelecom.use",
