...
| Draft as of 2026-02-01 | *Computable Name*:EHDSMedicationPrescription |
  ...
  "differential" : {
    "element" : [
      ...
      },
      {
        ...
        "short" : "Effective date of the prescription. The prescription is not dispensable before this date. If missing this is authoring (issue) date. [Used for searching]",
        "definition" : "Effective date of the prescription. The prescription is not dispensable before this date. If missing this is authoring (issue) date. [Used for searching]",
        "min" : 0,
        "max" : "1",
        "type" : [
          {
