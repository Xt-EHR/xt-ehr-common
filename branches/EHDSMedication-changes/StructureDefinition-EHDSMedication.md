...
| Active as of 2026-01-25 | *Computable Name*:EHDSMedication |
  ...
  "differential" : {
    "element" : [
      ...
      },
      {
        ...
        "short" : "Marketing authorisation holder of the medicinal product. Relevant for identifying the exact product. If the marketing authorisationholder is not known, it can be the manufacturer.",
        "definition" : "Marketing authorisation holder of the medicinal product. Relevant for identifying the exact product. If the marketing authorisationholder is not known, it can be the manufacturer.",
        "min" : 0,
        "max" : "1",
        "type" : [
          {
      ...
      },
      {
        ...
        "short" : "Substance that the strength refers to, in case it's different from .item.strength.substance",
        "definition" : "Substance that the strength refers to, in case it's different from .item.strength.substance",
        "min" : 0,
        "max" : "1",
        "type" : [
          {
      ...
      },
      {
        ...
        "short" : "Additional features of the product, e.g. whether it is reimbursible, ",
        "definition" : "Additional features of the product, e.g. whether it is reimbursible, ",
        "min" : 0,
        "max" : "*",
        "type" : [
          {
