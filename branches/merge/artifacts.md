...
### EHDS Common Logical Models 

Information models shared across different priority categories. Additional requirements may be provided below in the Obligations section.
...
Information models derived from EHDS information models including obligations for data elements. These obligations are default obligations across use cases.

| | |
| :--- | :--- |
| [Advance directive obligations](StructureDefinition-EHDSAdvanceDirectiveObligations.md) | Obligations for the logical model for advance directive. |
| [Alert obligations](StructureDefinition-EHDSAlertObligations.md) | Obligations for the logical model for alert. |
| [AllergyIntolerance obligations](StructureDefinition-EHDSAllergyIntoleranceObligations.md) | Obligations for the logical model for allergy intolerance. |
| [Condition obligations](StructureDefinition-EHDSConditionObligations.md) | Obligations for the logical model for condition. |
| [Current pregnancy obligations](StructureDefinition-EHDSCurrentPregnancyObligations.md) | Obligations for the logical model for current pregnancy. |
| [Device obligations](StructureDefinition-EHDSDeviceObligations.md) | Obligations for the logical model for device. |
| [Device use obligations](StructureDefinition-EHDSDeviceUseObligations.md) | Obligations for the logical model for device use. |
| [Dosage obligations](StructureDefinition-EHDSDosageObligations.md) | Obligations for the logical model for dosage. |
| [Health professional obligations](StructureDefinition-EHDSHealthProfessionalObligations.md) | Obligations for the logical model for health professional. |
| [Immunisation obligations](StructureDefinition-EHDSImmunisationObligations.md) | Obligations for the logical model for immunisation. |
| [Medication model obligations](StructureDefinition-EHDSMedicationObligations.md) | Obligations for the logical model for medication. |
| [Medication dispense model obligations](StructureDefinition-EHDSMedicationDispenseObligations.md) | Obligations for the logical model for medication dispense for dispensing/pharmacy systems (producer) and prescribing systems or prescription repositories(consumer). |
| [Medication prescription model obligations](StructureDefinition-EHDSMedicationPrescriptionObligations.md) | Obligations for the logical model for medication prescription body for prescribing systems (producer) and dispensing systems (consumer). |
| [MedicationAdministration obligations](StructureDefinition-EHDSMedicationAdministrationObligations.md) | Obligations for the logical model for medication administration. |
| [MedicationUse obligations](StructureDefinition-EHDSMedicationUseObligations.md) | Obligations for the logical model for medication use. |
| [Observation Obligations](StructureDefinition-EHDSObservationObligations.md) | Obligations for the logical model of general observation |
| [Organisation obligations](StructureDefinition-EHDSOrganisationObligations.md) | Obligations for the logical model for organisation. |
| [Patient obligations](StructureDefinition-EHDSPatientObligations.md) | Obligations for the logical model for patient. |
| [Patient summary obligations](StructureDefinition-EHDSPatientSummaryObligations.md) | Obligations for the logical model for patient summary. |
| [Procedure obligations](StructureDefinition-EHDSProcedureObligations.md) | Obligations for the logical model for procedure. |
| [Related person obligations](StructureDefinition-EHDSRelatedPersonObligations.md) | Obligations for the logical model for related person. |

### EHDS Laboratory Domain Obligations 

Information models derived from EHDS information models including obligations for data elements. These obligations apply to laboratory domain use cases.

| | |
| :--- | :--- |
| [Body structure laboratory specific obligations](StructureDefinition-EHDSBodyStructureLaboratoryObligations.md) | Obligations for the logical model of body structure in the scope of laboratory use case |
| [Condition laboratory specific obligations](StructureDefinition-EHDSConditionLaboratoryObligations.md) | Obligations for the logical model of condition in the scope of laboratory use case |
| [Device laboratory specific obligations](StructureDefinition-EHDSDeviceLaboratoryObligations.md) | Obligations for the logical model of device in the scope of laboratory use case |
| [Health professional laboratory specific obligations](StructureDefinition-EHDSHealthProfessionalLaboratoryObligations.md) | Obligations for the logical model of health professional in the scope of laboratory use case |
| [Immunisation laboratory specific obligations](StructureDefinition-EHDSImmunisationLaboratoryObligations.md) | Obligations for the logical model of immunisation in the scope of laboratory use case |
| [Laboratory observation obligations](StructureDefinition-EHDSLaboratoryObservationObligations.md) | Obligations for the logical model of laboratory observation |
| [Laboratory Report Obligations](StructureDefinition-EHDSLaboratoryReportObligations.md) | Obligations for the logical model of laboratory report |
| [Medication Administration laboratory specific obligations](StructureDefinition-EHDSMedicationAdministrationLaboratoryObligations.md) | Obligations for the logical model of medication administration in the scope of laboratory use case |
| [Medication laboratory specific obligations](StructureDefinition-EHDSMedicationLaboratoryObligations.md) | Obligations for the logical model of medication in the scope of laboratory use case |
| [Medication Use laboratory specific obligations](StructureDefinition-EHDSMedicationUseLaboratoryObligations.md) | Obligations for the logical model of medication use in the scope of laboratory use case |
| [Organisation laboratory specific obligations](StructureDefinition-EHDSOrganisationLaboratoryObligations.md) | Obligations for the logical model of organisation in the scope of laboratory use case |
| [Patient laboratory specific obligations](StructureDefinition-EHDSPatientLaboratoryObligations.md) | Obligations for the logical model of patient in the scope of laboratory use case |
| [Procedure laboratory specific obligations](StructureDefinition-EHDSProcedureLaboratoryObligations.md) | Obligations for the logical model of procedure in the scope of laboratory use case |
| [Related person laboratory specific obligations](StructureDefinition-EHDSRelatedPersonLaboratoryObligations.md) | Obligations for the logical model of related person in the scope of laboratory use case |
| [Service request laboratory specific obligations](StructureDefinition-EHDSServiceRequestLaboratoryObligations.md) | Obligations for the logical model of service request in the scope of laboratory use case |
| [Specimen Obligations](StructureDefinition-EHDSSpecimenLaboratoryObligations.md) | Obligations for the logical model of specimen |

### EHDS Discharge Report Domain Obligations 

Information models derived from EHDS information models including obligations for data elements. These obligations apply to discharge report domain use cases.

| | |
| :--- | :--- |
| [Discharge Report Obligations](StructureDefinition-EHDSDischargeReportObligations.md) | Obligations for the logical model of discharge report. |

### EHDS Imaging Domain Obligations 

Information models derived from EHDS information models including obligations for data elements. These obligations apply to discharge report domain use cases.

| | |
| :--- | :--- |
| [Imaging Report Obligations](StructureDefinition-EHDSImagingReportObligations.md) | Obligations for the logical model of imaging report. |
| [Imaging Study Obligations](StructureDefinition-EHDSImagingStudyObligations.md) | Obligations for the logical model of imaging study. |
