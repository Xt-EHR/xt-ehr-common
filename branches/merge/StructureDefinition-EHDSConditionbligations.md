...
| | |
| :--- | :--- |
| *Official URL*:http://www.xt-ehr.eu/fhir/models/StructureDefinition/EHDSConditionbligations | *Version*:0.4.0 |
| Draft as of 2026-02-24 | *Computable Name*:EHDSConditionbligations |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/xtehr.eu.ehds.models|current/StructureDefinition/EHDSConditionbligations)
...
Other representations of profile: [CSV](StructureDefinition-EHDSConditionbligations.csv), [Excel](StructureDefinition-EHDSConditionbligations.xlsx) 
...
```json
{
  ...
  "id" : "EHDSConditionbligations",
  "url" : "http://www.xt-ehr.eu/fhir/models/StructureDefinition/EHDSConditionbligations",
  "version" : "0.4.0",
  "name" : "EHDSConditionbligations",
  "title" : "Condition obligations",
  "status" : "draft",
  "date" : "2026-02-24T17:40:52+00:00",
  "publisher" : "Xt-EHR",
  "contact" : [{
    "name" : "Xt-EHR",
    "telecom" : [{
