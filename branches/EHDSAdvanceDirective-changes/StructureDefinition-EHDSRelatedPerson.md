...
| Draft as of 2026-02-01 | *Computable Name*:EHDSRelatedPerson |
...
* Use this Logical Model: [Device use model](StructureDefinition-EHDSDeviceUse.md), [Discharge Report model](StructureDefinition-EHDSDischargeReport.md), [Imaging report model](StructureDefinition-EHDSImagingReport.md), [Laboratory report model](StructureDefinition-EHDSLaboratoryReport.md)... Show 2 more, [Medication dispense model](StructureDefinition-EHDSMedicationDispense.md) and [Observation model](StructureDefinition-EHDSObservation.md)
