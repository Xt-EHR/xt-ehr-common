...
| Draft as of 2026-02-09 | *Computable Name*:EHDSObservation |
...
```json
{
  ...
  "differential" : {
    "element" : [
      ...
      {
        "id" : "EHDSObservation.basedOn[x]",
        "path" : "EHDSObservation.basedOn[x]",
        "short" : "A plan, proposal or order that is fulfilled in whole or in part by this observation.",
        "definition" : "A plan, proposal or order that is fulfilled in whole or in part by this observation.",
        "min" : 0,
        "max" : "*",
        "type" : [
          {
