...
| Draft as of 2026-01-29 | *Computable Name*:EHDSSpecimen |
...
* Use this Logical Model: [Imaging report model](StructureDefinition-EHDSImagingReport.md), [Imaging study model](StructureDefinition-EHDSImagingStudy.md), [Laboratory report model](StructureDefinition-EHDSLaboratoryReport.md), [Media model](StructureDefinition-EHDSMedia.md)... Show 3 more, [Observation model](StructureDefinition-EHDSObservation.md), [Service request model](StructureDefinition-EHDSServiceRequest.md) and [Specimen model](StructureDefinition-EHDSSpecimen.md)
...
```json
{
  ...
  "status" : "draft",
  "date" : "2026-01-29T12:00:01+00:00",
  "publisher" : "Xt-EHR",
  "contact" : [
    {
      "name" : "Xt-EHR",
  ...
  "differential" : {
    "element" : [
      ...
      },
      {
        ...
        "definition" : "The role the specimen serves",
        "min" : 0,
        "max" : "*",
        "type" : [
          {
      ...
      {
        "id" : "EHDSSpecimen.collection.collectionPeriod",
        "path" : "EHDSSpecimen.collection.collectionPeriod",
      ...
      {
        "id" : "EHDSSpecimen.collection.collectionProcedure",
        "path" : "EHDSSpecimen.collection.collectionProcedure",
      ...
      },
      {
        ...
        "short" : "Date and time that the material is handed over at the laboratory.",
        "definition" : "Date and time that the material is handed over at the laboratory.",
        "min" : 0,
        "max" : "1",
        "type" : [
          {
      ...
      },
      {
        ...
        "definition" : "State of the specimen",
        "min" : 0,
        "max" : "*",
        "type" : [
          {
