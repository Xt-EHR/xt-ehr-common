...
```json
{
  ...
  "status" : "draft",
  "date" : "2026-02-06T17:48:37+00:00",
  "publisher" : "Xt-EHR",
  "contact" : [
    {
      "name" : "Xt-EHR",
  ...
  "differential" : {
    "element" : [
      ...
      },
      {
        ...
        "short" : "A reference to reason why this service is being requested.",
        "definition" : "A reference to reason why this service is being requested.",
        "min" : 0,
        "max" : "*",
        "type" : [
          {
