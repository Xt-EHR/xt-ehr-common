...
| Draft as of 2026-02-09 | *Computable Name*:EHDSServiceRequest |
...
```json
{
  ...
  "status" : "draft",
  "date" : "2026-02-09T09:32:05+00:00",
  "publisher" : "Xt-EHR",
  "contact" : [
    {
      "name" : "Xt-EHR",
  ...
  "differential" : {
    "element" : [
      ...
      },
      {
        ...
        "short" : "A code, text or reference to reason why this service is being requested.",
        "definition" : "A code, text or reference to reason why this service is being requested.",
        "min" : 0,
        "max" : "*",
        "type" : [
          {
      ...
      {
        "id" : "EHDSServiceRequest.supportingInformationReference[x]",
        "path" : "EHDSServiceRequest.supportingInformationReference[x]",
        "short" : "A reference to the health conditions and other clinical information relevant for the results interpretation, e.g. fasting status, sex for clinical use, etc.",
        "definition" : "A reference to the health conditions and other clinical information relevant for the results interpretation, e.g. fasting status, sex for clinical use, etc.",
        "min" : 0,
        "max" : "*",
        "type" : [
          {
