# Discharge Report model - EHDS Logical Information Models v0.2.0
...
| | |
| :--- | :--- |
| *Official URL*:https://www.xt-ehr.eu/specifications/fhir/StructureDefinition/EHDSDischargeReport | *Version*:0.2.0 |
| Draft as of 2025-12-23 | *Computable Name*:EHDSDischargeReport |
...
```json
{
  ...
  "url" : "https://www.xt-ehr.eu/specifications/fhir/StructureDefinition/EHDSDischargeReport",
  "version" : "0.2.0",
  "name" : "EHDSDischargeReport",
  "title" : "Discharge Report model",
  "status" : "draft",
  "date" : "2025-12-23T08:26:30+00:00",
  "publisher" : "Xt-EHR",
  "contact" : [
    {
      "name" : "Xt-EHR",
  ...
  "kind" : "logical",
  "abstract" : false,
  "type" : "https://www.xt-ehr.eu/specifications/fhir/StructureDefinition/EHDSDischargeReport",
  ...
  "differential" : {
    "element" : [
      ...
      },
      {
        ...
        "type" : [
          {
            "code" : "https://www.xt-ehr.eu/specifications/fhir/StructureDefinition/EHDSAdvanceDirective"
          }
        ]
      },
      {
      ...
      },
      {
        ...
        "type" : [
          {
            "code" : "https://www.xt-ehr.eu/specifications/fhir/StructureDefinition/EHDSFunctionalStatus"
          }
        ]
      },
      {
      ...
      },
      {
        ...
        "type" : [
          {
            "code" : "https://www.xt-ehr.eu/specifications/fhir/StructureDefinition/EHDSDeviceUse"
          }
        ]
      },
      {
      ...
      },
      {
        ...
        "type" : [
          {
            "code" : "https://www.xt-ehr.eu/specifications/fhir/StructureDefinition/EHDSInfectiousContact"
          }
        ]
      },
      {
        ...
        "type" : [
          {
            "code" : "https://www.xt-ehr.eu/specifications/fhir/StructureDefinition/EHDSTravelHistory"
          }
        ]
      },
      {
      ...
      },
      {
        ...
        "type" : [
          {
            "code" : "https://www.xt-ehr.eu/specifications/fhir/StructureDefinition/EHDSPregnancyHistory"
          }
        ]
      },
      {
      ...
      },
      {
        ...
        "type" : [
          {
            "code" : "https://www.xt-ehr.eu/specifications/fhir/StructureDefinition/EHDSFamilyMemberHistory"
          }
        ]
      },
      {
      ...
      },
      {
        ...
        "type" : [
          {
            "code" : "https://www.xt-ehr.eu/specifications/fhir/StructureDefinition/EHDSSubstanceUse"
          }
        ]
      },
      {
      ...
      },
      {
        ...
        "type" : [
          {
            "code" : "https://www.xt-ehr.eu/specifications/fhir/StructureDefinition/EHDSMedicationStatement"
          }
        ]
      },
      {
