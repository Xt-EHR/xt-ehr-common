# Substance use model - EHDS Logical Information Models v0.2.0
...
| | |
| :--- | :--- |
| *Official URL*:https://www.xt-ehr.eu/specifications/fhir/StructureDefinition/EHDSSubstanceUse | *Version*:0.2.0 |
| Draft as of 2026-01-23 | *Computable Name*:EHDSSubstanceUse |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/eu.ehds.models|current/StructureDefinition/EHDSSubstanceUse)
