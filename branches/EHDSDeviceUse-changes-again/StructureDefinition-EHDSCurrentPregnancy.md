...
| Draft as of 2026-02-05 | *Computable Name*:EHDSCurrentPregnancy |
...
```json
{
  ...
  "differential" : {
    "element" : [
      ...
      {
        "id" : "EHDSCurrentPregnancy.header.authorship.author[x]",
        "path" : "EHDSCurrentPregnancy.header.authorship.author[x]",
