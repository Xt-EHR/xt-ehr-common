...
| Draft as of 2026-02-05 | *Computable Name*:EHDSPregnancyHistory |
...
```json
{
  ...
  "differential" : {
    "element" : [
      ...
      {
        "id" : "EHDSPregnancyHistory.header.authorship.author[x]",
        "path" : "EHDSPregnancyHistory.header.authorship.author[x]",
