...
| [Administered dosaging model](StructureDefinition-EHDSAdministeredDosaging.md) |  |
...
| [Dosaging model](StructureDefinition-EHDSDosaging.md) | The model covers usage instructions for administering a medicinal product, focusing on the most frequently used data elements. More complex dosage schemes may require additional elements, which should be communicated as part of the rendered dosage instructions element. |
