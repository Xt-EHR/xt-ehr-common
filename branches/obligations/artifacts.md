...
| [Medication dispense model obligations](StructureDefinition-EHDSMedicationDispenseObligations.md) | Obligations for the logical model for medication dispense for dispensing/pharmacy systems. |
| [Medication prescription model obligations](StructureDefinition-EHDSMedicationPrescriptionObligations.md) | Obligations for the logical model for medication prescription body for prescribing systems. |
