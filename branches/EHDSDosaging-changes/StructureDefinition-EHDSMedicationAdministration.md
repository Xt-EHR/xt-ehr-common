...
| Draft as of 2026-02-04 | *Computable Name*:EHDSMedicationAdministration |
...
```json
{
  ...
  "differential" : {
    "element" : [
      ...
      {
        "id" : "EHDSMedicationAdministration.dosage.dosageDetails",
        "path" : "EHDSMedicationAdministration.dosage.dosageDetails",
        "max" : "1"
      },
      {
        "id" : "EHDSMedicationAdministration.dosage.dosageDetails.sequence",
        "path" : "EHDSMedicationAdministration.dosage.dosageDetails.sequence",
        "max" : "0"
      },
      {
        "id" : "EHDSMedicationAdministration.dosage.dosageDetails.repeat",
        "path" : "EHDSMedicationAdministration.dosage.dosageDetails.repeat",
        "max" : "0"
      },
      {
        "id" : "EHDSMedicationAdministration.dosage.dosageDetails.asNeeded",
        "path" : "EHDSMedicationAdministration.dosage.dosageDetails.asNeeded",
        "max" : "0"
      }
    ]
  }
