# Condition model - EHDS Logical Information Models v0.4.0
...
| | |
| :--- | :--- |
| *Official URL*:http://www.xt-ehr.eu/fhir/models/StructureDefinition/EHDSCondition | *Version*:0.4.0 |
| Draft as of 2026-03-05 | *Computable Name*:EHDSCondition |
...
* Derived from this Logical Model: [Condition obligations](StructureDefinition-EHDSConditionObligations.md)
