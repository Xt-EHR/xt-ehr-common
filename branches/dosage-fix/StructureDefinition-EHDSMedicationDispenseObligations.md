...
| Draft as of 2026-03-05 | *Computable Name*:EHDSMedicationDispenseObligations |
...
```json
{
  ...
  "differential" : {
    "element" : [{
      ...
      "definition" : "Obligations for the logical model for medication dispense for dispensing/pharmacy systems (producer) and prescribing systems or prescription repositories(consumer)."
    },
    {
