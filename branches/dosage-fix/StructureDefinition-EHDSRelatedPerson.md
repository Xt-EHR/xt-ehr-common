# Related person model - EHDS Logical Information Models v0.4.0
...
| | |
| :--- | :--- |
| *Official URL*:http://www.xt-ehr.eu/fhir/models/StructureDefinition/EHDSRelatedPerson | *Version*:0.4.0 |
| Draft as of 2026-03-05 | *Computable Name*:EHDSRelatedPerson |
...
* Derived from this Logical Model: [Related person obligations](StructureDefinition-EHDSRelatedPersonObligations.md)
